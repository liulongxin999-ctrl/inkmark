...
function noteCard(n) {
  const card = el('div', {
    ...
    el('div', { class: 'nc-head' },
      el('span', { class: `pill${n.kind === 'quote' ? '' : ' ok'}`, text: n.kind === 'quote' ? '引文' : n.kind === 'term' ? '术语' : '笔记' }),
    ...
    n.kind === 'quote' && n.quote ? el('div', { class: 'nc-body', style: { fontFamily: 'var(--serif)', borderLeft: '2px solid var(--line-2)', paddingLeft: '8px', marginBottom: '6px' }, text: n.quote }) : null,
...
export function openNoteEditor(note) {
  ...
  const bodyWrap = el('div', {},
    ...
    n.kind === 'quote' && n.quote ? el('div', { class: 'card', style: { marginBottom: '10px' } },
